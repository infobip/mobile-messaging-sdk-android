...
interface CallNotificationFactory {
    ...
    fun createScreenSharingNotification(): Notification
}
...
internal class CallNotificationFactoryImpl(
    ...
    companion object {
        private const val INCOMING_CALL_NOTIFICATION_CHANNEL_ID = "com.infobip.conversations.app.INCOMING_CALL_NOTIFICATION_CHANNEL_ID"
        private const val IN_CALL_NOTIFICATION_CHANNEL_ID = "com.infobip.conversations.app.IN_CALL_NOTIFICATION_CHANNEL_ID"
        private const val SCREEN_SHARING_NOTIFICATION_CHANNEL_ID = "com.infobip.conversations.app.SCREEN_SHARING_NOTIFICATION_CHANNEL_ID"
    ...
    init {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            createNotificationChannel(context.getString(R.string.mm_calls_notification_channel), INCOMING_CALL_NOTIFICATION_CHANNEL_ID, NotificationManager.IMPORTANCE_HIGH)
            createNotificationChannel(context.getString(R.string.mm_in_call_notification_channel), IN_CALL_NOTIFICATION_CHANNEL_ID, NotificationManager.IMPORTANCE_DEFAULT)
            createNotificationChannel(context.getString(R.string.mm_screen_sharing), SCREEN_SHARING_NOTIFICATION_CHANNEL_ID, NotificationManager.IMPORTANCE_DEFAULT)
        }
    }

    @RequiresApi(Build.VERSION_CODES.O)
    private fun createNotificationChannel(name: String, channelId: String, importance: Int) {
        notificationManager.createNotificationChannel(NotificationChannel(channelId, name, importance).apply {
            description = name
            enableLights(true)
    ...
    override fun createOngoingCallNotification(
        ...
        val hangupIntent = PendingIntent.getService(
                context, CALL_HANGUP_REQUEST_CODE, Intent(context, OngoingCallService::class.java).apply {
    ...
    override fun createScreenSharingNotification(): Notification {
    ...
    private fun contentIntent(title: String): PendingIntent {
        ...
        return PendingIntent.getActivity(context, CALL_NOTIFICATION_CONTENT_REQUEST_CODE, contentIntent, updateCurrentImmutableFlags)
    }
}