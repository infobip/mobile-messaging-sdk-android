    ...
    private void setUpRuntimeCustomization() {
        findViewById(R.id.customization).setOnClickListener(v -> {
            ...
            InAppChatStyle chatStyle = new InAppChatStyle.Builder()
                ...
                .setNetworkConnectionErrorIcon(getDrawable(R.drawable.ic_notification))
                ...
                .setChatSnackbarErrorIcon(getDrawable(org.infobip.mobile.messaging.chat.R.drawable.ib_chat_refresh_icon))
