...
// Source from
// https://github.com/aosp-mirror/platform_frameworks_support/blob/df40ba39ba85fb8629d135bfcd54c1186cf0a4b5/core/src/main/java/androidx/core/app/JobIntentService.java

// Modifies the original class to avoid SecurityException reported on JobIntentService: https://issuetracker.google.com/issues/63622293.
// This class might be removed if the same fix is provided by Google.
...
public abstract class JobIntentService extends Service {
    ...
    final class CommandProcessor extends MMAsyncTask<Void, Void, Void> {
        @Override
     ...
     * {@link MMAsyncTask#cancel(boolean) AsyncTask.cancel(true)} to interrupt the running
     * task.
     *
    ...
    void ensureProcessorRunningLocked(boolean reportStarted) {
        if (mCurProcessor == null) {
            ...
            mCurProcessor.executeOnExecutor(MMAsyncTask.THREAD_POOL_EXECUTOR);
        }
    }
    ...
    GenericWorkItem dequeueWork() {
        ...
        if (mCompatQueue == null) return null;
        synchronized (mCompatQueue) {
