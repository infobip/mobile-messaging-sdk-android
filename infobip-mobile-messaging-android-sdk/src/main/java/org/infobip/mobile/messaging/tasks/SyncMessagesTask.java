...
public class SyncMessagesTask extends AsyncTask<Object, Void, SyncMessagesResult> {
    ...
    protected SyncMessagesResult doInBackground(Object... notUsed) {
        ...
        try {
            ...
            SyncMessagesResponse syncMessagesResponse = MobileApiResourceProvider.INSTANCE.getMobileApiMessages(context).syncMessages(deviceApplicationInstanceId, syncMessagesBody);
