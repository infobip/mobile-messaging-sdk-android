...
2. Prepare your Infobip account (https://portal.infobip.com/push/)8 to get your Application Code:
...
4. Add dependencies to app/build.gradle
    ...
    dependencies {
        ...
        compile ('org.infobip.mobile.messaging.api:infobip-mobile-messaging-android-sdk:1.2.17@aar') {
            transitive = true;
        }
    }
    ```
